...
/***/ function(module, exports) {
	...
	var Util = (function () {
	    ...
	    _createClass(Util, null, [{
	         ...
	         * @returns {*}
	         */
	        value: function getMin(num1, num2) {
	            var tansit = num1;
	            if (num2 < num1) {
	                tansit = num2;
	            }
	        ...
	        key: "getMax",
	        value: function getMax(num1, num2) {
	            var tansit = num1;
	            if (num2 > num1) {
	                tansit = num2;
	            }
	        ...
	        key: "merge",
	        value: function merge(obj, obj2, override) {
	            var res = obj;
	            //  遍历第二个对象
	            for (var i in obj2) {
	                //  支持重写,且原对象存在该属性值
	        ...
	        key: "convertTime",
	        value: function convertTime(date, format) {
	            //  最终的日期对象
	            var finalDate = date instanceof Date ? date : new Date();
	            ...
	            //  最后要输出时间格式
	            var finalFormart = format || "yyyy-mm-dd HH:MM:ss";

	            //  组织个数组方便转换
	            var formatArr = /\s/.test(finalFormart) ? finalFormart.split(" ") : [finalFormart];
	        ...
	        key: "runCallback",
	        value: function runCallback(config) {
	            var defaults = {
